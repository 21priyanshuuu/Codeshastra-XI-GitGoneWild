...
interface FacialVerificationProps {
  onVerify: (facialData: string) => void
}

export function FacialVerification({ onVerify }: FacialVerificationProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="text-center mb-4">
        <h3 className="text-lg font-medium text-white">Facial Verification</h3>
        <p className="text-sm text-gray-400">Please look at the camera for identity verification</p>
      </div>
